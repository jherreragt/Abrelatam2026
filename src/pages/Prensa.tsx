...
const copy: Record<Language, any> = {
  ...
  pt: {
    ...
    heroSubtitle: 'Recursos, comunicados e materiais para meios de comunicação que cobrem ABRELATAM / CONDATOS 2026.',
    aboutLabel: 'Sobre o evento',
    aboutTitle: 'Para meios de comunicação',
    aboutParagraphs: [
      'ABRELATAM e CONDATOS 2026 reunirão na Cidade da Guatemala mais de 500 pessoas de toda a América Latina e Caribe.',
      'Durante três dias, ativistas, funcionários públicos, desenvolvedores, jornalistas e acadêmicos compartilharão experiências e apresentarão projetos inovadores.',
      'Esta será a primeira vez em vários anos que as conferências retornam à América Central.',
    ],
    resourcesLabel: 'Recursos',
    kitTitle: 'Kit de imprensa',
    kit: {
      release: { title: 'Comunicado de imprensa', desc: 'Informação oficial sobre o evento.', action: 'Baixar PDF', url: null },
      logos: { title: 'Logos e imagens', desc: 'Logos oficiais do evento em alta resolução.', action: 'Baixar ZIP', url: null },
      facts: { title: 'Dados e números', desc: 'Estatísticas sobre edições anteriores.', action: 'Ver documento', url: FACTS_URL },
      bios: { title: 'Biografias de palestrantes', desc: 'Informações sobre os principais palestrantes.', action: 'Em breve', url: null },
    },
    contactTitle: 'Contato para imprensa',
    contactText: 'Para consultas, entrevistas ou mais informações, contate nossa equipe de comunicação.',
    contactEmail: 'abrelatam@idatosabiertos.org',
  },
};
