...
const historyParagraphs = ['history1', 'history2', 'history3', 'history4', 'history4b', 'history5'] as const;
    ...
    <>
      ...
      <Section bgColor="white" className="py-24 md:py-32">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="mb-8 text-3xl font-bold text-[#262262] md:text-4xl">
            {t('about.historyTitle')}
          </h2>
          <div className="space-y-7 text-base font-medium leading-relaxed text-[#262262] md:text-lg">
      ...
      <Section bgColor="gray" className="py-20 md:py-28">
        <div className="mx-auto max-w-5xl">
          <h2 className="mb-14 text-center text-3xl font-bold text-[#262262] md:text-4xl">
            {t('about.objectivesTitle')}
          </h2>
          <div className="grid gap-8 md:grid-cols-2">
            {objectives.map(({ icon, key }) => (
              <article key={key} className="rounded-2xl bg-white px-9 py-8">
                <img src={icon} alt="" className="mb-5 h-16 w-16 object-contain" />
                <h3 className="mb-2 text-xl font-bold leading-tight text-[#262262]">
                  {t(`about.objectives.${key}.title`)}
                </h3>
                <p className="text-base font-medium leading-relaxed text-[#262262]">
      ...
      <Section bgColor="white" className="py-24 md:py-32">
        <div className="mx-auto max-w-5xl">
          <h2 className="mb-14 text-3xl font-bold text-[#262262] md:text-4xl">
            {t('about.audienceTitle')}
          </h2>
          <div className="space-y-9">
            {audienceKeys.map((key) => (
              <article key={key} className="border-l-2 border-[#329bd0] pl-5">
                <h3 className="text-2xl font-bold leading-tight text-[#262262]">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {editions.map(({ year, cityKey }, index) => (
              <article key={`${year}-${cityKey}-${index}`} className="rounded-lg bg-white px-8 py-10">
                <h3 className="text-xl font-bold leading-tight text-[#262262]">
                  {year}
                </h3>
                <p className="mt-1 text-lg font-medium leading-tight text-[#262262]">
