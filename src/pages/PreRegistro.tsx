...
const copy: Record<Language, {
  ...
  es: {
    ...
    benefits: {
      ...
      noCommitment: { title: 'Evento gratuito', desc: 'El evento es gratuito, sin embargo los participantes deberán ser responsables de su transporte y estadía (con excepción de aquellas personas que reciben una beca por parte del evento)' },
    },
  ...
  en: {
    ...
    benefits: {
      ...
      noCommitment: { title: 'Free event', desc: 'The event is free, however participants will be responsible for their transportation and accommodation (except for those who receive a scholarship from the event)' },
    },
  ...
  pt: {
    ...
    benefits: {
      ...
      noCommitment: { title: 'Evento gratuito', desc: 'O evento é gratuito, porém os participantes serão responsáveis por seu transporte e hospedagem (com exceção das pessoas que recebem bolsa do evento)' },
    },
