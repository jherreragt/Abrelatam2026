        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
            {sections.map(({ icon: Icon, key }) => (
              <div
                key={key}
                className="bg-slate-50 rounded-2xl p-7 border border-slate-100 flex flex-col gap-4"
              >
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 flex items-center justify-center gap-3">
                <HelpCircle size={26} className="text-[#329bd0]" />
            ...
            <div className="space-y-2">
              {faqKeys.map((key, i) => (
                ...
                >
                  ...
                  >
                    <h3 className="font-semibold text-slate-900 text-sm leading-relaxed flex-1">
