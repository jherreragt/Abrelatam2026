...
const copy: Record<Language, any> = {
  ...
  pt: {
    heroTitle: 'Código de conduta',
    heroSubtitle: 'Nosso compromisso com um espaço seguro, respeitoso e inclusivo para todas as pessoas que participam do ABRELATAM / CONDATOS.',
    commitmentTitle: 'Nosso compromisso',
    commitmentText: 'ABRELATAM / CONDATOS se compromete a oferecer uma experiência de conferência livre de assédio para todas as pessoas.',
    expectedLabel: 'Esperado',
    expectedTitle: 'Comportamento esperado',
    expected: {
      respect: { title: 'Respeito mútuo', desc: 'Tratar todas as pessoas com respeito e consideração, valorizando diversos pontos de vista e experiências.' },
      constructive: { title: 'Comunicação construtiva', desc: 'Ser gentil na fala e nas ações. Criticar ideias, não pessoas.' },
      inclusion: { title: 'Inclusão ativa', desc: 'Buscar perspectivas diversas e criar espaços onde todas as vozes possam ser ouvidas.' },
      empathy: { title: 'Empatia', desc: 'Ter consciência do impacto que nossas palavras e ações têm nas outras pessoas.' },
      collaboration: { title: 'Colaboração', desc: 'Trabalhar em conjunto de forma construtiva, reconhecendo que todas as pessoas têm algo valioso a contribuir.' },
    },
    unacceptableLabel: 'Inaceitável',
    unacceptableTitle: 'Comportamento inaceitável',
    unacceptableIntro: 'Não será tolerada nenhuma forma de assédio.',
    unacceptable: {
      offensive: 'Comentários ofensivos relacionados a gênero, identidade e expressão de gênero, orientação sexual, deficiência, aparência física, idade, raça, etnia, nacionalidade ou religião.',
      unwantedComments: 'Comentários indesejados sobre escolhas e práticas de estilo de vida de uma pessoa.',
      physicalContact: 'Contato físico inapropriado ou atenção sexual indesejada.',
      intimidation: 'Intimidação deliberada, perseguição ou acompanhamento.',
      harassingPhoto: 'Fotografia ou gravação assediadora.',
      disruption: 'Interrupção sustentada de conversas, palestras ou outros eventos.',
      advocacy: 'Defesa ou incentivo de qualquer um dos comportamentos anteriores.',
    },
    consequencesLabel: 'Consequências',
    consequencesTitle: 'Consequências do descumprimento',
    consequences1: 'Espera-se que pessoas solicitadas a interromper um comportamento inaceitável o façam imediatamente.',
    consequences2: 'A equipe organizadora reserva-se o direito de proibir a participação em eventos futuros de pessoas que violem o código de conduta.',
    reportLabel: 'Reportar',
    reportTitle: 'Reportar um incidente',
    reportText: 'Se você experimentar ou presenciar comportamento inaceitável, reporte o quanto antes.',
    formNotice: 'Seu reporte será revisado pela equipe de resposta do código de conduta.',
    anonymous: 'Enviar reporte de forma anônima',
    name: 'Seu nome (opcional)',
    email: 'Email (opcional)',
    incident: 'Descrição do incidente',
    incidentPlaceholder: 'Descreva o que aconteceu com o máximo de detalhes possível...',
    ...
    directText: 'Você também pode contatar diretamente a equipe do código de conduta:',
    directAvailability: 'Durante o evento, haverá pessoas identificadas da equipe disponíveis o tempo todo.',
  },
};
