...
const translations = {
  es: {
    ...
    admin: {
      ...
      signUpTitle: 'Crear cuenta de administrador',
      signUpSubtitle: 'Regístrate para administrar el sitio',
  ...
  en: {
    ...
    admin: {
      ...
      signUpSubtitle: 'Register to manage the site',
      email: 'Email',
      password: 'Password',
      signIn: 'Sign in',
      signUp: 'Sign up',
  ...
  pt: {
    ...
    admin: {
      ...
      signUpTitle: 'Criar conta de administrador',
      signUpSubtitle: 'Registre-se para administrar o site',
      email: 'E-mail',
      password: 'Senha',
      signIn: 'Entrar',
      signUp: 'Registrar-se',
